...
@media (max-width: 480px) {
    ...
    .personal-info h1, .education h2, .work-experience h2, .skills h2 {
        font-size: 18px;
    }

    .education-container, .work-experience-container, .skills-container {
        margin-bottom: 20px;
    }
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function setupResumeButton(username) {
        const button = document.getElementById('url-resume');
        if (!button) {
    ...
    function setupShareButton(username) {
        const button = document.getElementById('share-resume');
        if (!button) {
